...
## 2026-08-24 — v2.1.0 macOS Apple Silicon 资产

- 为现有 v2.1.0 补充原生 `EduGate.app` 与 `EduGate-Standalone-v2.1.0-macos-arm64.zip` 构建流程；产品内容和功能版本不变。支持 macOS 11+ 的 Apple Silicon（arm64），不支持 Intel Mac。
...
- 发布包 SHA-256：`14190035347549e74fbd838ab986f865e2c327a8c936b14784736d26293a143b`。

Windows x64 与 macOS Apple Silicon 安装包共用 [v2.1.0 Release](https://github.com/bd4rex/EduGate-standalone/releases/tag/v2.1.0)。
